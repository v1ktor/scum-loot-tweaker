...
export function SettingsTab(props: SettingsTabProps) {
    ...
    return (
        <div className="grid grid-cols-[7fr_3fr] gap-8 mt-4">
            <div>
                <InputField
                    value={spawner.Probability ?? ''}
                    id="probability"
                    label="Probability"
                    onChange={handleFieldChange('Probability')}
                    onClear={handleFieldClear('Probability')}
                    tooltipContent={<ProbabilityTooltip probability={spawner.Probability} />}
                />
                <div className="flex gap-4">
                    <InputField
                        value={spawner.QuantityMin ?? ''}
                        id="quantity-min"
                        label="Quantity Min"
                        onChange={handleFieldChange('QuantityMin')}
                        onClear={handleFieldClear('QuantityMin')}
                        tooltipContent={<QuantityTooltip />}
                    />
                    <InputField
                        value={spawner.QuantityMax ?? ''}
                        id="quantity-max"
                        label="Quantity Max"
                        onChange={handleFieldChange('QuantityMax')}
                        onClear={handleFieldClear('QuantityMax')}
                        tooltipContent={<QuantityTooltip />}
                    />
                </div>
                <div className="flex gap-4">
                    <InputField
                        value={spawner.InitialDamage ?? ''}
                        id="initial-damage"
                        label="Initial damage"
                        onChange={handleFieldChange('InitialDamage')}
                        onClear={handleFieldClear('InitialDamage')}
                        tooltipContent={<InitialDamageTooltip />}
                    />
                    <InputField
                        value={spawner.RandomDamage ?? ''}
                        id="random-damage"
                        label="Random damage"
                        onChange={handleFieldChange('RandomDamage')}
                        onClear={handleFieldClear('RandomDamage')}
                        tooltipContent={<RandomDamageTooltip />}
                    />
                </div>
                <div className="flex gap-4">
                    <InputField
                        value={spawner.InitialUsage ?? ''}
                        id="initial-usage"
                        label="Initial Usage"
                        onChange={handleFieldChange('InitialUsage')}
                        onClear={handleFieldClear('InitialUsage')}
                        tooltipContent={<InitialUsageTooltip />}
                    />
                    <InputField
                        value={spawner.RandomUsage ?? ''}
                        id="random-usage"
                        label="Random Usage"
                        onChange={handleFieldChange('RandomUsage')}
                        onClear={handleFieldClear('RandomUsage')}

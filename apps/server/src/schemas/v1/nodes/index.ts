...
export const GetNodesSchema = Type.Object({
    filenames: Type.Array(Type.String(), {
        examples: [['Airfield.json', 'Bar.json', 'Barn.json']],
    }),
});

export const GetNodeSchema = Type.Recursive(
    (Node) =>
        Type.Object({
            ...
            PostSpawnActions: Type.Optional(
                Type.Array(Type.String(), {
                    examples: [['SetAmmoAmount_BigStash', 'SetClothesDirtiness_ResidentialClothes']],
                }),
            ),
        }),
    { $id: 'GetNodeSchema' },
...
export const GetChildrenSchema = Type.Recursive(
    (Node) =>
        Type.Object({
            Name: Type.String({ examples: ['ItemLootTreeNodes'] }),
            Rarity: RaritySchema,
